...
export default function TraceDetailModal({ traceId, open, onClose }: TraceDetailModalProps) {
  ...
  const fetchTraceDetail = async (id: string) => {
    console.log('[fetchTraceDetail] Called with id:', id);
    console.log('[fetchTraceDetail] fetchingRef.current:', fetchingRef.current);

    // If already fetching, don't start another request
    if (fetchingRef.current) {
      console.log('[fetchTraceDetail] Already fetching, skipping');
      return;
    }

    fetchingRef.current = true;
    abortRef.current = new AbortController();
    console.log('[fetchTraceDetail] Created new AbortController');
